...
import org.testng.annotations.Test;
    ...
    public class DoctorLogin extends HMS{
        ...
        public void TC_WB_DL2_firstwronglogin() throws InterruptedException {
            ...
            login.click();
            Thread.sleep(2000);
            String actualUrl="http://localhost:7882/Hospital%20Management%20System/hospital/hms/doctor/index.php";//Enter the link of the web page to which login page will direct us.
            String expectedUrl= driver.getCurrentUrl();
            Assert.assertEquals(expectedUrl,actualUrl);
            System.out.println("------------------------------------------------------------------");
        }
